    ...
    <section id="achievements" className="relative py-32 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="flex flex-col items-center text-center mb-16">
          <div className="flex items-center gap-2 text-sky-500 font-mono text-sm tracking-[0.2em] uppercase mb-4">
            <Terminal size={16} />
            <span>{t("achievements.label")}</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-black text-white">
            {t("achievements.title")}<span className="text-sky-500">.</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-[1.45fr_0.85fr] gap-6">
          <motion.div
            ...
            className="group relative overflow-hidden rounded-3xl border border-white/10 bg-[#0F172A] p-7 md:p-9 shadow-2xl"
          >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_10%_0%,rgba(56,189,248,0.17),transparent_45%),radial-gradient(circle_at_95%_100%,rgba(168,85,247,0.16),transparent_42%)]" />
            <div className="relative">
              <div className="flex items-center justify-between gap-4 mb-9">
                <div className="flex items-center gap-3 text-sky-400 font-mono text-xs font-bold tracking-[0.16em] uppercase">
              ...
              {achievements.map((achievement) => (
                <div key={achievement.id} className="relative pl-7 border-l border-sky-500/40">
                  <span className="absolute -left-[5px] top-1.5 size-2 rounded-full bg-sky-400 shadow-[0_0_14px_rgba(56,189,248,0.9)]" />
                  ...
                  <div className="mt-6 flex items-center gap-2 text-sm font-mono text-sky-400">
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl border border-dashed border-slate-700 bg-slate-900/50 p-7 md:p-9"
          >
            ...
            <div className="relative flex h-full min-h-60 flex-col justify-between">
              <div>
                <div className="flex size-12 items-center justify-center rounded-2xl bg-violet-500/10 text-violet-400 border border-violet-500/20">
                  <FileBadge size={22} />
                </div>
                <h3 className="mt-6 text-xl font-bold text-white">{t("achievements.certificates")}</h3>
